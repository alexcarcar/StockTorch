"""
Zen AI Price Action Signals for GWRE using Matplotlib
This script fetches historical price data for GWRE from Yahoo Finance,
applies the Zen AI price action logic to generate buy and sell signals,
and visualizes the results using Matplotlib.

https://zentradingtech.com/2025/08/18/orlando-workshop-back-to-basics-docs-replay/
https://zentradingtech.com/2025/11/27/always-in-indicator-for-tradingview/
Always-In Indicator (TradingView)

Highlights bars to show market bias (long or short).
Based on Dr. Al Brooks’ concepts.
Not for trade entries; for context and training.


Key Rules

Two consecutive bars same direction (bull or bear).
Both close on same side of MA (EMA/SMA adjustable).
...
Bull: green bars; Bear: red bars.
Optional arrows; MA toggle.


Usage

Identify Always-In bias.
Filter weak countertrend setups.
